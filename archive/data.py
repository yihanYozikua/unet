...
def testGenerator_v2(test_path, num_image_from, num_image_to, target_size=(256, 256), flag_multi_class=False, as_gray=False):
    for i in range(num_image_from, num_image_to):
        # Read the image
        img = io.imread(os.path.join(test_path, "BraTS_GLI_00000_000_%d.png" % i), as_gray=as_gray)
...
def testGenerator_brats(test_path, num_image_from, num_image_to, target_size=(256, 256), flag_multi_class=False, as_gray=True):
    for i in range(num_image_from, num_image_to):
        # Read the image
        img = io.imread(os.path.join(test_path, "BraTS_GLI_00000_000_%d.png" % i), as_gray=False)
